...
describe("fetchYouTubeVideos", () => {
  ...
  beforeEach(() => {
    ...
    vi.mocked(mockedFirestore.collection).mockImplementation((collectionName) => {
  ...
  it("動画を取得してFirestoreに書き込むこと", async () => {
    ...
    expect(mockMetadataDocSet).toHaveBeenCalledWith(expect.objectContaining({
      isInProgress: false,
