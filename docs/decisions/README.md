...
- [ADR-002: Entity実装の教訓](architecture/ADR-002-entity-implementation-lessons.md) - Entity/PlainObjectパターンの維持決定
- [ADR-003: Firestoreクエリ最適化](architecture/ADR-003-firestore-query-optimization.md) - クエリパフォーマンス改善
- [ADR-003: 関数型アーキテクチャ移行](architecture/ADR-003-functional-architecture-migration.md) - 関数型パターンへの移行検討
