...
**本番システム稼働中** (v0.3.12) - 2026年5月22日時点

### ✅ v0.3.12（現行）- 依存関係更新・コード品質改善

- **📦 依存関係の最新化**: Next.js 16, React 19, Tailwind CSS v4, Zod v4, Node.js 24 等に更新
- **⚡ React Compiler導入**: Next.js 16 対応の自動最適化
...
1. **Discord認証システム** - better-auth + Guild確認・isActive ゲート完了
...
6. **収益化システム** - Google AdSense統合・Cookie同意・プライバシーポリシー対応完了
7. **UIコンポーネントライブラリ** - packages/ui統合・Storybook・包括的テストスイート完了
...
- **2026年5月22日**: v0.3.12反映・技術スタック更新（Next.js 16, React 19, Tailwind v4, Zod v4）
- **2025年10月13日**: v0.3.11 — Server Actions大規模リファクタリング・works/buttons/actionsのモジュール分割
- **2025年8月12日**: v0.3.10 — ドキュメント整理・コレクション名統一（dlsiteWorks → works）
