...
- **DLsite作品詳細表示**: ファイル・クリエイター・特典情報の包括的表示 (トラック情報はDLsite制約により非対応)
- **高解像度画像対応**: DLsite Individual Info APIからの高品質画像取得・表示
...
- **`dlsiteWorks`**: DLsite作品情報 (自動収集・ファイル/クリエイター/特典データ含む、トラック情報は制約により非対応)
