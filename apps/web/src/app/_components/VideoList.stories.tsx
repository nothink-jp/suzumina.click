...
const mockVideos: Video[] = [
  ...
  { 
    ...
    description: "YOASOBIさんの「群青」を歌わせていただきました。素敵な楽曲をありがとうございます。",
  ...
  { 
    ...
    description: "YOASOBIさんの「アイドル」を歌わせていただきました。素敵な楽曲をありがとうございます。",
  ...
  { 
    ...
    description: "YOASOBIさんの「夜に駆ける」を歌わせていただきました。素敵な楽曲をありがとうございます。",
  ...
  { 
    ...
    description: "優里さんの「ロウワー」を歌わせていただきました。素敵な楽曲をありがとうございます。",
...
const meta = {
  ...
  argTypes: {
    ...
    showViewAllLink: {
      ...
      description: "「もっと見る」ボタンの代わりに全一覧ページへのリンクを表示するかどうか",
    },
    pageSize: {
      control: { type: "number" },
