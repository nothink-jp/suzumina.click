			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
					...
					<div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
							...
							<div className="space-y-4">
								...
								{work.rating && (
									<div className="flex items-center gap-3">
										...
										<span className="text-sm text-gray-600">({work.rating.count}件の評価)</span>
									</div>
								)}
						...
						{work.description && (
							<div className="p-6 border-t border-gray-200">
								<h2 className="text-xl font-semibold text-gray-900 mb-3">作品説明</h2>
				...
				<div className="space-y-6">
					...
					<div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
						<h3 className="text-lg font-semibold text-gray-900 mb-4">サークル情報</h3>
					...
					{work.author && work.author.length > 0 && (
						<div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
							<h3 className="text-lg font-semibold text-gray-900 mb-4">出演声優</h3>
							<div className="space-y-3">
