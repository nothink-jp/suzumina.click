...
※イヤホン・ヘッドホンでのご利用を推奨します。`,
	...
	thumbnailUrl: "https://img.dlsite.jp/modpub/images2/work/doujin/RJ123456/RJ123456_img_main.jpg",
	price: {
		current: 880,
		original: 1100,
		currency: "JPY",
	...
	salesCount: 15000,
	ageRating: "R-18",
	tags: ["ASMR", "耳かき", "癒し", "バイノーラル", "涼花みなせ", "安眠", "リラックス", "立体音響"],
	sampleImages: [],
	isExclusive: true,
...
const mockWorkDataMinimal: FrontendDLsiteWorkData = {
	...
	thumbnailUrl: "https://img.dlsite.jp/modpub/images2/work/doujin/RJ234567/RJ234567_img_main.jpg",
	price: {
		current: 550,
		currency: "JPY",
	},
...
const mockWorkDataGame: FrontendDLsiteWorkData = {
	...
	thumbnailUrl: "https://img.dlsite.jp/modpub/images2/work/doujin/RJ345678/RJ345678_img_main.jpg",
	price: {
		current: 1980,
		currency: "JPY",
	},
