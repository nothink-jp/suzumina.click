				...
				<Card>
					...
					<CardContent className="space-y-4">
						...
						<div className="bg-muted p-4 rounded-lg">
							<h4 className="font-semibold text-foreground mb-2">重要事項</h4>
				...
				<Card>
					...
					<CardContent className="space-y-4">
						<div className="space-y-3">
							...
							<div className="bg-muted p-4 rounded-lg">
								<h4 className="font-semibold text-foreground mb-2">権利者の皆様へ</h4>
								<p className="text-sm text-muted-foreground">
					...
					<CardContent className="space-y-4">
						<div className="space-y-3">
							...
							<div className="bg-muted p-3 rounded-lg">
								<h4 className="font-semibold text-foreground mb-2">透明性について</h4>
								<p className="text-sm text-muted-foreground">
