		...
		children: (
			<div className="max-w-7xl mx-auto space-y-8">
				...
				<div className="bg-white rounded-lg shadow-sm p-8">
					<h2 className="text-2xl font-semibold text-gray-800 mb-6">🎵 コンテンツを楽しむ</h2>
					<div className="grid gap-6 md:grid-cols-2">
						<div className="p-6 bg-purple-50 border border-purple-200 rounded-lg">
							<h3 className="text-xl font-medium text-purple-900 mb-2">📺 動画一覧</h3>
							<p className="text-purple-700">涼花みなせさんのYouTube動画を視聴</p>
						</div>
						<div className="p-6 bg-muted border rounded-lg">
							<h3 className="text-xl font-medium text-foreground mb-2">🎧 音声作品一覧</h3>
							<p className="text-muted-foreground">DLsite音声作品を探索・購入</p>
						</div>
					</div>
				</div>
			</div>
...
export const VideoListPage: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "動画一覧ページの完全なレイアウト。グリッドレイアウトとページネーションを含む。",
			},
		},
	},
};
