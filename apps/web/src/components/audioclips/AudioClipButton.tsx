...
export default function AudioClipButton({
  ...
  return (
    <div className="flex items-center p-3 bg-white rounded-lg shadow-sm border border-gray-200 hover:bg-gray-50 transition-colors">
      {/* 再生ボタン */}
      <button
        type="button"
        onClick={handlePlay}
      ...
      {user && (
        <button
          ...
          aria-label={localFavorite ? "お気に入りから削除" : "お気に入りに追加"}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
