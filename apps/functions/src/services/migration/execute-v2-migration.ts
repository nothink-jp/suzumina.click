...
import { V2MigrationRollbackService } from "./rollback-v2-migration";
import { V2MigrationValidationService } from "./validate-v2-migration";
...
if (require.main === module) {
	...
	if (!phase) {
		console.error("使用方法: node execute-v2-migration.js <phase> [options]");
