 ...
 */
export async function fetchWorkInfo(
  productId: string,
): Promise<DLsiteInfoResponse | null> {
  try {
 ...
 */
export function extractRatingDetails(
 ...
 */
export function extractRankingInfo(
  infoData: DLsiteInfoResponse,
): RankingInfo[] {
 ...
 */
export function extractLocalePrices(
  infoData: DLsiteInfoResponse,
): LocalePrice[] {
 ...
 */
export function extractTranslationInfo(
  infoData: DLsiteInfoResponse,
 ...
 */
export function extractLanguageDownloads(
  infoData: DLsiteInfoResponse,
): LanguageDownload[] {
  if (
    !infoData.language_editions ||
    !Array.isArray(infoData.language_editions)
  ) {
    return [];
  }
 ...
 */
export function extractSalesStatus(
  infoData: DLsiteInfoResponse,
...
export function extractVoiceActors(infoData: DLsiteInfoResponse): string[] {
  ...
  return infoData.voice_actors.filter(
