...
import { AudioButtonId, AudioButtonV2 } from "../audio-button-v2";
...
describe("AudioButtonV2", () => {
	...
	describe("fromLegacy", () => {
		it("should create from legacy format", () => {
			...
			const button = AudioButtonV2.fromLegacy(legacyData);
		...
		it("should handle missing optional fields", () => {
			...
			const button = AudioButtonV2.fromLegacy(minimalData);
	...
	describe("validation", () => {
		...
		it("should validate creator info", () => {
			const button = new AudioButtonV2(
