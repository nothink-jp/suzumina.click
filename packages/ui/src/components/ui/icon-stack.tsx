		...
		>
			...
			{children ? (
				<div
					...
					className="-translate-x-1/2 -translate-y-1/2 -skew-y-26 pointer-events-none absolute top-[var(--icon-stack-content-y)] left-[var(--icon-stack-content-x)] flex scale-x-90 items-center justify-center text-muted-foreground"
				>
					{children}
				</div>
			) : null}
